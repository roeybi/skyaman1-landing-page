    ...
    <div className="min-h-screen" style={{ background: BEIGE, fontFamily: "'Georgia', serif" }}>
      ...
      <main className="max-w-3xl mx-auto py-14 px-6 space-y-8 text-sm leading-relaxed" style={{ color: "#3A2E24" }}>
        ...
        <section>
          ...
          <p>Sky Alliance Enterprise ("we", "our", or "us") is committed to protecting your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit this website or submit an enquiry form.</p>
          <p className="mt-3">This website is independently operated by a real estate agent from the appointed agency Sky Alliance Enterprise, and is not the official website of the developer. All information provided is for reference only.</p>
        </section>
        ...
        <section>
          ...
          <p>We process your personal data based on your explicit consent provided when you submit the enquiry form. You have the right to withdraw your consent at any time by contacting us.</p>
        </section>
        ...
        <section>
          ...
          <p>We retain your personal data only for as long as necessary to fulfil the purposes outlined in this Privacy Policy, or as required by law. Enquiry data is typically retained for 24 months from the date of collection.</p>
        </section>
        ...
        <section>
          ...
          <p>This website may use cookies to enhance your browsing experience. You can control cookie settings through your browser settings. Disabling cookies may affect some features of this website.</p>
        </section>
        ...
        <div className="pt-4">
          <a href="/" className="inline-flex items-center gap-2 text-xs tracking-widest uppercase" style={{ color: DARK_BROWN, textDecoration: "underline" }}>
            ← Back to Main Page
          </a>
        </div>
      </main>
      ...
      <footer className="py-8 px-4 text-center" style={{ background: FOOTER_BG }}>
        <p className="text-xs" style={{ color: "#4A3728" }}>© 2026 Sky Aman 1 Residences. All Rights Reserved.</p>
